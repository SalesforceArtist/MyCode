describe("Jasmine Spy", function() {
	...
	it("Tracking spies with calls property",function(){
		...
		expect(alice.calculateSalary.calls.count()).toEqual(2);
		...
		console.log(alice.calculateSalary.calls.argsFor(2)); // returns array [1000]
		expect(alice.calculateSalary.calls.argsFor(2)).toEqual([1000]);
