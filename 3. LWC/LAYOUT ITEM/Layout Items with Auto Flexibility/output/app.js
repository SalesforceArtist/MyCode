    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 1
      }, [api_text("The layout items below become as wide as necessary to occupy the entire width of the container with "), api_element("code", {
        key: 0
      }, [api_text("flexibility=\"auto\"")]), api_text(".")]), api_element("div", {
        classMap: {
          "slds-box": true,
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-flexibility_flexibility-host",
      shadowAttribute: "c-flexibility_flexibility"
    };

    class LightningExampleLayoutItemFlexibility extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutItemFlexibility, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-flexibility', { is: main, fallback: true });
