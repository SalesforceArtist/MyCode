    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 1
      }, [api_text("Layout with items having default size 6 and and size set to 3 for medium. The medium size is used for devices like tablets and wider than tablets, such as desktop monitors. The default size is used for devices narrower than tablets, such as smart phones. For more information about device sizes, see the "), api_element("a", {
        attrs: {
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-sizeOverriddenForTablets_sizeOverriddenForTablets-host",
      shadowAttribute: "c-sizeOverriddenForTablets_sizeOverriddenForTablets"
    };

    class LightningExampleLayoutItemSizeOverriddenForTablets extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutItemSizeOverriddenForTablets, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-sizeOverriddenForTablets', { is: main, fallback: true });
