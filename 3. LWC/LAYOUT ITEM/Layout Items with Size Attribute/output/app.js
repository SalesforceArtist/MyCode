    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        ...
        key: 0
      }, [api_text("size=\"4\"")]), api_text(", or 4 columns of a 12 column grid. Each item occupies 33.33% of the width.")]), api_element("div", {
        classMap: {
          "slds-box": true,
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-size_size-host",
      shadowAttribute: "c-size_size"
    };

    class LightningExampleLayoutItemSize extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutItemSize, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-size', { is: main, fallback: true });
