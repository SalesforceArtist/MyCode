    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 1
      }, [api_text("The third layout items specify "), api_element("code", {
        key: 0
      }, [api_text("alignment-bump=\"left\"")]), api_text(" to create a margin on its left. The margin is the width of the unused horizontal space.")]), api_element("div", {
        classMap: {
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-alignmentBump_alignmentBump-host",
      shadowAttribute: "c-alignmentBump_alignmentBump"
    };

    class LightningExampleLayoutItemAlignmentBump extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutItemAlignmentBump, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-alignmentBump', { is: main, fallback: true });
