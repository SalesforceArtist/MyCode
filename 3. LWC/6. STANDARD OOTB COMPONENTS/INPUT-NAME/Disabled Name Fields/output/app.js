    ...
    * */
    ...
    class LightningInputName extends lwc.LightningElement {
      ...
      setCustomValidityForField(message, fieldName) {
        assert$1(DEFAULT_FIELD_META[fieldName] !== undefined, `Invalid 'fieldName': ${fieldName}`);
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-input-name", _lightningInputName, {
        props: {
    ...
    tmpl$p.stylesheetTokens = {
      hostAttribute: "c-disabled_disabled-host",
      shadowAttribute: "c-disabled_disabled"
    };

    class InputNameFieldLevelHelp extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(InputNameFieldLevelHelp, {
      fields: ["salutationsList"]
    });

    var main = lwc.registerComponent(InputNameFieldLevelHelp, {
      tmpl: _tmpl$o
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-disabled', { is: main, fallback: true });
