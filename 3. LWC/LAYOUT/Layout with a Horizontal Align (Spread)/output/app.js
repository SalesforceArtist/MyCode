    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 1
      }, [api_text("The layout items are spaced horizontally across the container, starting and ending with a layout item using attribute "), api_element("code", {
        key: 0
      }, [api_text("horizontal-align=\"spread\"")]), api_text(".")]), api_element("div", {
        classMap: {
          "c-container": true
        },
        key: 19
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-horizontalAlignSpread_horizontalAlignSpread-host",
      shadowAttribute: "c-horizontalAlignSpread_horizontalAlignSpread"
    };

    class LightningExampleLayoutSpread extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutSpread, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-horizontalAlignSpread', { is: main, fallback: true });
