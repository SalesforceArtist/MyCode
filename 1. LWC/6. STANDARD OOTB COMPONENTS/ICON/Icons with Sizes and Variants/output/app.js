(function (lwc) {
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".dark-background" + shadowSelector + "{background-color: #16325c;padding: 12px;color: #fff;}\n.row" + shadowSelector + "{margin:10px 0 10px;}\n";
    }
    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        attrs: {
          "id": api_scoped_id("size")
        },
        key: 6
      }, [api_element("h4", {
        key: 0
      }, [api_text("Utility icons in different sizes")]), api_custom_element("lightning-icon", _lightningIcon, {
        props: {
        ...
        attrs: {
          "id": api_scoped_id("inverse")
        },
        key: 13
      }, [api_element("h4", {
        key: 7
      }, [api_text("Utility icons with inverse variant in different sizes")]), api_custom_element("lightning-icon", _lightningIcon, {
        props: {
          "iconName": "utility:connected_apps",
          "alternativeText": "Connected",
          "variant": "inverse",
        ...
        attrs: {
          "id": api_scoped_id("variants")
        },
        key: 37
      }, [api_element("h4", {
        key: 14
      }, [api_text("Utility icons with default styling and with success, warning, and error variants")]), api_custom_element("lightning-icon", _lightningIcon, {
        props: {
        ...
        props: {
          ...
          "alternativeText": "Warning!",
          "variant": "warning",
          "title": "warning variant xx-small",
          "size": "xx-small"
        },
        key: 25
      }, []), api_element("br", {
        ...
        props: {
          ...
          "alternativeText": "Money",
          "title": "money icon with success variant",
          "variant": "success"
        },
        key: 34
      }, []), api_custom_element("lightning-icon", _lightningIcon, {
        props: {
          ...
          "alternativeText": "Light bulb",
          "title": "light bulb with warning variant",
          "variant": "warning"
        },
        key: 35
      }, []), api_custom_element("lightning-icon", _lightningIcon, {
        props: {
          ...
          "title": "hide icon with error variant",
          "variant": "error"
        },
        key: 36
      }, [])]), api_element("div", {
        ...
        key: 38
      }, [api_text("Action icons in various sizes")]), api_custom_element("lightning-icon", _lightningIcon, {
        props: {
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-variants_variants-host",
      shadowAttribute: "c-variants_variants"
    };

    class Variants extends lwc.LightningElement {}

    var main = lwc.registerComponent(Variants, {
      tmpl: _tmpl$3
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-variants', { is: main, fallback: true });
