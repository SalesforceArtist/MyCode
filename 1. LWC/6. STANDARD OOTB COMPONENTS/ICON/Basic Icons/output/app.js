    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        ...
        attrs: {
          "id": api_scoped_id("doctype")
        },
        key: 13
      }, [api_text("Doctype icons represent a type of file when a preview or image is unavailable. "), api_element("br", {
        key: 7
      }, []), api_element("br", {
        key: 8
      }, []), api_custom_element("lightning-icon", _lightningIcon, {
        ...
        attrs: {
          "id": api_scoped_id("standard")
        },
        key: 20
      }, [api_text("Standard icons represent entities and objects within Salesforce. "), api_element("br", {
        key: 14
      }, []), api_element("br", {
        key: 15
      }, []), api_custom_element("lightning-icon", _lightningIcon, {
        ...
        attrs: {
          "id": api_scoped_id("utility")
        },
        key: 27
      }, [api_text("Utility icons are used throughout the interface and are SVGs for extensibility. "), api_element("br", {
        key: 21
      }, []), api_element("br", {
        key: 22
      }, []), api_custom_element("lightning-icon", _lightningIcon, {
        ...
        attrs: {
          "id": api_scoped_id("custom")
        },
        key: 34
      }, [api_text("Custom icons are available in Salesforce to represent user created objects."), api_element("br", {
        key: 28
      }, []), api_element("br", {
        key: 29
      }, []), api_custom_element("lightning-icon", _lightningIcon, {
    ...
    class Basic extends lwc.LightningElement {}

    var main = lwc.registerComponent(Basic, {
      tmpl: _tmpl$3
    });
