(function (lwc) {
    ...
    **/
    ...
    tmpl$8.stylesheetTokens = {
      hostAttribute: "c-selected_selected-host",
      shadowAttribute: "c-selected_selected"
    };

    class DualListboxSelected extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.options = [];
        this.values = [];
    ...
    lwc.registerDecorators(DualListboxSelected, {
      track: {
        options: 1,
        values: 1
      }
    ...
    var main = lwc.registerComponent(DualListboxSelected, {
      tmpl: _tmpl$9
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-selected', { is: main, fallback: true });
