(function (lwc) {
    ...
    * */
    ...
    tmpl$p.stylesheetTokens = {
      hostAttribute: "c-base_base-host",
      shadowAttribute: "c-base_base"
    };

    class InputNameBase extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(InputNameBase, {
      fields: ["salutationsList"]
    });

    var main = lwc.registerComponent(InputNameBase, {
      tmpl: _tmpl$o
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-base', { is: main, fallback: true });
