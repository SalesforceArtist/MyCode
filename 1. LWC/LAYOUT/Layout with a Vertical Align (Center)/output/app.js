    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 0
      }, [api_text("The layout items are aligned in the center of the container.")]), api_element("div", {
        classMap: {
          "c-container": true
        },
        key: 18
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-verticalAlignCenter_verticalAlignCenter-host",
      shadowAttribute: "c-verticalAlignCenter_verticalAlignCenter"
    };

    class LightningExampleLayoutCenter extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutCenter, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-verticalAlignCenter', { is: main, fallback: true });
