    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 1
      }, [api_text("The layout items are spaced horizontally across the container, starting and ending with a space, using attribute "), api_element("code", {
        key: 0
      }, [api_text("horizontal-align=\"space\"")]), api_text(".")]), api_element("div", {
        classMap: {
          "c-container": true
        },
        key: 19
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-horizontalAlignSpace_horizontalAlignSpace-host",
      shadowAttribute: "c-horizontalAlignSpace_horizontalAlignSpace"
    };

    class LightningExampleLayoutSpace extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutSpace, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-horizontalAlignSpace', { is: main, fallback: true });
