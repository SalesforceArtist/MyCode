    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 1
      }, [api_text("These layout items specify "), api_element("code", {
        key: 0
      }, [api_text("padding=\"horizontal-medium\"")]), api_text(" to give each item medium padding on its left and right sides.")]), api_element("div", {
        classMap: {
          "slds-box": true,
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-padding_padding-host",
      shadowAttribute: "c-padding_padding"
    };

    class LightningExampleLayoutItemPadding extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutItemPadding, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-padding', { is: main, fallback: true });
