    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 2
      }, [api_text("The third layout item adds a value of "), api_element("code", {
        key: 0
      }, [api_text("\"no-grow\"")]), api_text(" to the "), api_element("code", {
        key: 1
      }, [api_text("flexibility")]), api_text(" attribute. No space is assigned to that item in the container beyond the width of the content.")]), api_element("div", {
        classMap: {
          "slds-box": true,
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-flexibilityValues_flexibilityValues-host",
      shadowAttribute: "c-flexibilityValues_flexibilityValues"
    };

    class LightningExampleLayoutItemFlexibilityValues extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutItemFlexibilityValues, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-flexibilityValues', { is: main, fallback: true });
