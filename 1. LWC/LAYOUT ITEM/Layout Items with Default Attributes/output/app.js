    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 2
      }, [api_text("With default attribute values of "), api_element("code", {
        key: 0
      }, [api_text("size")]), api_text(" and "), api_element("code", {
        key: 1
      }, [api_text("flexibility")]), api_text(", layout items take the size of their content and don't occupy entire width of the container.")]), api_element("div", {
        classMap: {
          "slds-box": true,
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "c-default_default-host",
      shadowAttribute: "c-default_default"
    };

    class LightningExampleLayoutItemDefault extends lwc.LightningElement {}

    var main = lwc.registerComponent(LightningExampleLayoutItemDefault, {
      tmpl: _tmpl$2
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-default', { is: main, fallback: true });
