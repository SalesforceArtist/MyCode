(function (lwc) {
    ...
    * */
    ...
    tmpl$p.stylesheetTokens = {
      hostAttribute: "c-readOnly_readOnly-host",
      shadowAttribute: "c-readOnly_readOnly"
    };

    class InputNameReadOnly extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(InputNameReadOnly, {
      fields: ["salutationsList"]
    });

    var main = lwc.registerComponent(InputNameReadOnly, {
      tmpl: _tmpl$o
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-readOnly', { is: main, fallback: true });
