(function (lwc) {
    ...
    **/
    ...
    tmpl$8.stylesheetTokens = {
      hostAttribute: "c-minmax_minmax-host",
      shadowAttribute: "c-minmax_minmax"
    };

    class DualListboxMinMax extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.options = [];
        this.values = [];
    ...
    lwc.registerDecorators(DualListboxMinMax, {
      track: {
        options: 1,
        values: 1,
        requiredOptions: 1
    ...
    var main = lwc.registerComponent(DualListboxMinMax, {
      tmpl: _tmpl$9
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-minmax', { is: main, fallback: true });
