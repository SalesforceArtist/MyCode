    ...
    **/
    ...
    function tmpl$8($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-dual-listbox", _lightningDualListbox, {
        ...
        key: 1
      }, [api_text("Selected values are: "), api_dynamic($cmp.selected)])])];
    }

    var _tmpl$9 = lwc.registerTemplate(tmpl$8);
    tmpl$8.stylesheets = [];
    tmpl$8.stylesheetTokens = {
      hostAttribute: "c-simple_simple-host",
      shadowAttribute: "c-simple_simple"
    };

    class DualListboxSimple extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this._selected = [];
      }
    ...
    lwc.registerDecorators(DualListboxSimple, {
      track: {
        _selected: 1
      }
    });

    var main = lwc.registerComponent(DualListboxSimple, {
      tmpl: _tmpl$9
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-simple', { is: main, fallback: true });
